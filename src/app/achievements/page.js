    ...
    <div className={`${montserrat.className} flex flex-col w-full bg-[#030505] antialiased`}>
      ...
      <section className="w-full block">
        <div className="w-full py-[40px] px-[20px] flex justify-center">
          <div className="grid grid-cols-9 auto-rows-[60.188px] auto-cols-[120.102px] gap-[20px] mx-auto max-w-[1560px] w-full relative">
...
{selectedCard && (
  ...
  <div   className="relative w-[600px] rounded-3xl overflow-hidden p-6 flex gap-4 text-white
  border border-white/10 backdrop-blur-xl shadow-xl
  bg-[linear-gradient(135deg,rgba(14,14,14,0.6),rgba(5,16,15,0.6),rgba(25,66,66,0.6))]"
 > 
  ...
  <div className="flex flex-col flex-1">
    ...
    <ul className="list-disc pl-5 mb-4 space-y-1 text-[0.9rem] text-white/80">
    ...
    <div className="flex justify-between items-center mt-auto border-t border-white/10 pt-3">
      <div className="flex items-center gap-3">
        <img src="/mdi_github.svg" alt="GitHub" className="w-6 h-6" />
        <LinkedinIcon />
        <InstagramIcon />
      </div>
      <span className="bg-white/10 border border-white/10 px-3 py-1 rounded-full text-sm whitespace-nowrap">
        Intern @PlayAI
      </span>
    </div>
  </div>
