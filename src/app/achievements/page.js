    ...
    >
      ...
      <div className="pt-[15px]">
        ...
        <div className="flex justify-between items-center border-t border-t-[#333] pt-[10px] text-[0.8rem]">
          ...
          <button onClick={() => { console.log("View More clicked");  }} className="bg-[#33334f] px-[8px] py-[4px] rounded-[10px] font-semibold whitespace-nowrap border-2 border-[rgba(255,255,255,0.01)] hover:border-[rgba(255,255,255,0.1)] px-4 py-2 rounded">View More +</button>
